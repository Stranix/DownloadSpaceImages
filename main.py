...
from download_apod_images import fetch_apod_images
from download_epic_images import fetch_epic_images
...
if __name__ == '__main__':
    ...
    fetch_apod_images(nasa_token, namespace.apod_image_count)
